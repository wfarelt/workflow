                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('workflow-tareas.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Nuevo workflow tipo de tarea') }}
                                </a>
                              </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('workflow-tareas.destroy',$workflowTarea->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('workflow-tareas.show',$workflowTarea->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('workflow-tareas.edit',$workflowTarea->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
