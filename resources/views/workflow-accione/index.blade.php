                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('workflow-acciones.destroy',$workflowAccione->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('workflow-acciones.show',$workflowAccione->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('workflow-acciones.edit',$workflowAccione->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
