                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('workflow-estados.destroy',$workflowEstado->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('workflow-estados.show',$workflowEstado->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('workflow-estados.edit',$workflowEstado->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
